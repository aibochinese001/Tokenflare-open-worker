/** Cerebras adapter — OpenAI-compatible (thin) + native passthrough. */
...
/**
 * Cerebras exposes an OpenAI-compatible API rooted at `/v1`, so the chat
 * endpoint lives at `/v1/chat/completions`. The adapter forwards the request
 * body with a Bearer key and returns the upstream Response untouched.
 */
